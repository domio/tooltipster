/**
 * @license Tooltipster 3.2.4 | 2014-05-14
            ...
            self.options.functionBefore.call(self.$el, self.$el, function () {
                ...
                if (self.enabled && self.Content !== null) {
                    ...
                    // if the tooltip isn't already open, open that sucker up!
                        ...
                        self.bodyOverflowX = bodyElement.css('overflow-x');
        ...
        _interval_set: function () {
            ...
            self.checkInterval = setInterval(function () {
                ...
                // if the origin has been removed
                    bodyElement.find(self.$el).length === 0 ||
                    // if the elProxy has been removed
                    bodyElement.find(self.$elProxy).length === 0 ||
                    // if the tooltip has been closed
                    self.Status == 'hidden' ||
                    // if the tooltip has somehow been removed
                    bodyElement.find(self.$tooltip).length === 0
                    ) {
        ...
        hide: function (callback) {
            ...
            if (self.Status == 'shown' || self.Status == 'appearing') {
                ...
                var finish = function () {
                    ...
                    // unbind any auto-closing click/touch listeners
                    bodyElement.off('.' + self.namespace);
        ...
        reposition: function () {
            ...
            if ($('body').find(self.$tooltip).length !== 0) {
                ...
                if (self.$elProxy.is('area')) {
                    ...
                    var areaLeft, areaTop, areaWidth, areaRight, areaBottom;
                    if (areaShape == 'circle') {
                ...
                var topDifference, borderWidth, newWidth;
                ...
                if (self.options.arrow) {
                    ...
                    var arrowClass = 'tooltipster-arrow-' + practicalPosition, arrowColor;
                    ...
                    var tooltipBorderWidth, tooltipBorderColor;
